...
deleteExistingTable();
// createTable('testing');
createTable("testing","sname VARCHAR(100) NOT NULL","money INT(20) NOT NULL ");
createTable("inventories","sname VARCHAR(100) NOT NULL","price INT(20) NOT NULL ","stock INT(20) NOT NULL ");
